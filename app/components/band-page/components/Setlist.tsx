...
function Setlist({ user, band, data, concert, setConcert }: SetlistProps) {
  ...
  return (
    ...
    >
      ...
      >
        {!data && (
          <div className="flex max-w-md flex-col items-center justify-center gap-2 self-center text-balance p-24 text-center text-sm">
            <ExclamationCircleIcon className="size-12 text-zinc-500" />
            <p className="text-lg font-medium">Network error</p>
            <p className="text-zinc-300">
              We couldn&apos;t fetch the setlist for this concert. Please try
              again later.
            </p>
          </div>
        )}
          ...
          <>
            ...
            {data && !data.setlist && (
              <div className="-mx-4 flex flex-col items-center gap-2 rounded-lg py-16">
                ...
                <p className="text-zinc-300">
                  Oh crap, there is no setlist for
                </p>
