...
function ConcertNotes({ user }: ConcertNotesProps) {
  return (
    <div className="-mx-10 -mb-1 mt-12 flex flex-col rounded-lg px-6 text-sm">
      ...
      <div className="flex flex-col gap-5">
        <div className="flex items-center gap-5 px-7">
          ...
          <p className="pr-8">
            This was the first time I saw Alcest live. It was an unforgettable
            experience. The band was kind enough to come take pictures and sign
            our stuff. 🫶
          </p>
        </div>
        <div className="flex items-center gap-5 px-7">
          <Icon name="CakeIcon" />
          <p className="pr-8">
            Best song for me was Autre Temps, I love it so much! Even better
            that this concert was on my birthday! :)
          </p>
        </div>
      </div>
    </div>
