              ...
              return (
                <button
                  ...
                  className={classNames(
                    '-ml-[1px] whitespace-nowrap border border-zinc-700/60 py-3 text-sm font-medium shadow-sm transition-colors duration-75 first:ml-0 first:rounded-tl last:rounded-tr hover:text-white',
                    {
